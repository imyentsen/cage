...
const BlogPost = ({ post }) => {
  return (
        <article key={post.id} className="mb-0 md:mb-8 px-0 pb-4 border-b-1 border-white md:border md:border-post md:border-2 md:outline-1 md:outline-gray-400 bg-post">
          ...
          <main>
            <div className='p-6 md:p-8'>
              <h2 className="text-2xl md:text-lg font-bold text-gray-900 font-title text-center leading-normal">
                {post.title}
              </h2>
            </div>
