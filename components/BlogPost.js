...
const BlogPost = ({ post }) => {
  return (
        <article key={post.id} className="mb-0 md:mb-8 px-0 pb-8 md:pb-4 border-b border-white md:border md:border-post md:border-8 bg-post">
          ...
          <main>
            ...
            <div className='py-2 h-14 flex flex-col'>
