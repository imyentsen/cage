...
const BlogPost = ({ post }) => {
  return (
        <article key={post.id} className="mb-0 md:mb-8 px-0 pb-4 border-b border-white md:border md:border-post md:border-2 md:outline md:outline-1 md:outline-offset-0 md:outline-gray-400 bg-post">
